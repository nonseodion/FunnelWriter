...
var editorContent = document.querySelector(".editor").value;
...
// function getStorageItem(){
  ...
  var  contentoutput = sessionStorage.getItem('short')
    let value =  contentoutput;
    // let str =  
    var   output = Object.values(JSON.parse(value)).map( result => console.log(result));
